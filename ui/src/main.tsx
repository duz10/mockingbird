...
createRoot(container).render(
  <React.StrictMode>
    {/* mb-e3z — catch runtime render throws anywhere in the router
        tree and show a graceful fallback instead of a blank webview. */}
    <ErrorBoundary>
      <HashRouter>
        <App>
          <Routes>
            ...
            <Route
              path="/history"
              element={<Navigate to="/dictations" replace />}
            />
