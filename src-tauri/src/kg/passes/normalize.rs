...
//! tag-collapse mechanism per PLAN §12.
//!
//! Per PLAN §7.2 Layer 3:
//! - lowercase
...
//! tags.
//!
//! Graduated from the sandbox verbatim under Wave 2 Task 6
//! (`mb-rtk2`) — no rule changes (LESSONS P9: normalize.rs is
