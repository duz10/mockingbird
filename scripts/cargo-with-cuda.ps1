...
#
# Usage examples:
#   pwsh scripts/cargo-with-cuda.ps1 check
#   pwsh scripts/cargo-with-cuda.ps1 test --release
#   pwsh scripts/cargo-with-cuda.ps1 clippy --release --all-targets -- -D warnings
#   pwsh scripts/cargo-with-cuda.ps1 fmt --check
#
