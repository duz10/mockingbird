...
**KG Phase 1D — source-gated filing + first-class KG screen** (ADR 0052 Proposed 2026-06-04). Re-scopes the standing "Phase 1D = backfill" framing (now moot per the 2026-06-04 source-of-truth alignment review against the original product spec §15 + Clark article). Six waves; Waves 1D.0 (charter + clean-slate verify + phase doc + bead epic) **and 1D.1 (migration 025 + source-gated dictation-tail hook) both complete**.
