...
**Last consolidated:** 2026-06-04 (**KG Phase 1E Wave 1E.3 shipped** — migration 026 + `vault::writer` module with two-phase commit + KG worker integration. Invariant probes (kg_parity 32/32, kg_source_gate 6/6, kg_graph_off) all GREEN; 4 P3 beads filed for deferred follow-ups). Prior anchors: 2026-06-04 earlier (**KG Phase 1D SEALED via ADR 0052 Accepted** — Wave 1D.6 three judges + epic seal); 2026-05-31 (**KG Phase 1C SEALED via ADR 0051 Accepted**); 2026-06-03 (ADR 0050 KG Phase 1B SEALED); 2026-05-30 (Wave 1C.0 charter).
...
**KG Phase 1E (Obsidian as source of truth) — Waves 1E.0 + 1E.1 + 1E.2 + 1E.3 shipped; Wave 1E.4 (History archive) ready next.** Charter ADR [ADR 0053](docs/adr/0053-kg-phase-1e-obsidian-as-source-of-truth.md) Proposed; phase doc at `docs/phases/phase-1e.md`; bead epic `mb-imc2` with 10 sub-beads. 1E.3 lands the two-phase commit -- KG filing worker now writes Markdown to the vault subtree after `apply_filed_outcome`, with SHA-256 pre-recorded for 1E.5 loop-prevention.

### Wave 1E.3 deliverables shipped (this iteration)
