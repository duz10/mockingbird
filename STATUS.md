...
- **Iteration 1 beads:**
  ...
  - Next: `mb-jbf7` Iter 1 smoke is Dustin's action — run against `C:\Users\dboyd\Downloads\New Recording 38.m4a` via the new `+ Audio file` button on the Dictations page. LESSONS P7 pattern (judges prove contracts; only live-OS smoke proves the end-to-end import path).
