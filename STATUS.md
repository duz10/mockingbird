...
- **Iteration 4: IN-FLIGHT.** Polish iteration; dispatched in pieces.
  ...
  - **Phase B (`mb-q1xt`): NEXT.** `+ Audio file` import progress indicator.
  - **Phase C (`mb-3xww`): backend pre-positioned; UI wizard pending.** Nested-vault detection dialog + guided-migration flow.
  - **Phase D: epic seal** (STATUS sweep + ADR Accepted-final + LESSONS amendment if anything surfaces in B/C).
