...
**KG Phase 1D — source-gated filing + first-class KG screen** (ADR 0052 Proposed 2026-06-04). Re-scopes the standing "Phase 1D = backfill" framing (now moot per the 2026-06-04 source-of-truth alignment review against the original product spec §15 + Clark article). Six waves; Waves 1D.0, 1D.1, **and 1D.2 (KG screen scaffold + read-only dashboard) complete**.
